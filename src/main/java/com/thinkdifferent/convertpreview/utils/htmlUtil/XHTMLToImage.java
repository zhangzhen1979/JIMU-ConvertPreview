...
public class XHTMLToImage {
    ...
    public static File convertToImage(String inputFilename, String strHtml,
        ...
        Java2DRenderer renderer = new Java2DRenderer(f, (widthImage + 20), (heightImage + 20));
    ...
    public static void main(final String[] args) throws Exception {
        ...
        if (args.length != 2) {
            inputFilename = "C:\\Java\\IdeaProjects\\convert-preview\\watermark\\aa.html";
            outputFilename = "C:\\Java\\IdeaProjects\\convert-preview\\watermark\\aa.png";
        } else {
        ...
        if (args.length == 4) {
            widthImage = Integer.parseInt("945");
            heightImage = Integer.parseInt("945");
        }
