...
public class DoubleLayerPdfUtil {
    ...
    private static File getTtfFile() throws IOException {
        if (ttfFile == null) {
            String fontFilePath = SpringUtil.getProperty("convert.pdf.font");
    ...
    public static void addText(File basePdfFile, List<Context> contexts) throws IOException {
        String path = basePdfFile.getParent() + File.separator;
