 ...
 */
package com.thinkdifferent.convertpreview.utils.pdfSignature.cert;
...
public class OcspHelper
{
            ...
            throws OCSPException, RevokedCertificateException, IOException
    {
        ...
        if (basicResponse != null)
        {
            ...
            // (...)
            // either the pdfSignName of the responder or a hash of the responder's
            ...
            else
            {
                ...
                {
                    throw new OCSPException("OCSP: basic response must provide pdfSignName or key hash");
                }
            }
