 ...
 *
 * {@code keytool -genkeypair -storepass 123456 -storetype pkcs12 -pdfAlias test -validity 365
...
public class CreateSignature extends CreateSignatureBase
{
    ...
    /**
     * Initialize the signature creator with a keystore and certificate pdfPassword.
     *
     * @param keystore the pkcs12 keystore containing the signing certificate
     * @param pin the pdfPassword for recovering the key
     * @throws KeyStoreException if the keystore has not been initialized (loaded)
     * @throws NoSuchAlgorithmException if the algorithm for recovering the key cannot be found
     * @throws UnrecoverableKeyException if the given pdfPassword is wrong
    ...
    public void signDetached(File file) throws IOException
    {
        signDetached(file, file, null,
                "Weaver", "Shanghai, China", "Sign the document.");
    }
     ...
     * @throws IOException if the input file could not be read
     */
    public void signDetached(File inFile, File outFile, String tsaUrl,
                             String name, String location, String reason) throws IOException
    {
    ...
    public static void main(String[] args) throws IOException, GeneralSecurityException
    {
        ...
        is.close();
        // TODO pdfAlias command line argument
    ...
    private static void usage()
    {
        System.err.println("usage: java " + CreateSignature.class.getName() + " " +
                           "<pkcs12_keystore> <pdfPassword> <pdf_to_sign>\n" + "" +
                           "options:\n" +
