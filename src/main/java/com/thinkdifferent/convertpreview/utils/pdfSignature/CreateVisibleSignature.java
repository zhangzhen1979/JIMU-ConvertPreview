...
public class CreateVisibleSignature extends CreateSignatureBase {
     ...
     * @param signedFile         The file to be signed.
     * @param tsaUrl             optional TSA url
     * @param signatureFieldName optional pdfSignName of an existing (unsigned) signature field
     * @throws IOException
     */
    ...
    public static void main(String[] args) throws KeyStoreException, CertificateException,
        ...
        // generate with
        // keytool -storepass 123456 -storetype PKCS12 -keystore file.p12 -genkey -pdfAlias client -keyalg RSA
        if (args.length < 4) {
            usage();
            System.exit(1);
        }
        ...
        imageStream.close();
        signing.setVisibleSignatureProperties("name", "pdfSignLocation", "Security", 0, page, true);
